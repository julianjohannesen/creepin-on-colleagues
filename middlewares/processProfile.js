...
export default function processProfile(profileJSON = {}){
	...
	return asyncHandler(
		...
		(profileJSON) => {
			...
			// "Badges" is an array of course objects. Using reduce(), for each "badge", we'll push that badge's course title to our parentCourse array or to our childCourses array. The child array is created by the accumulator in our reducer.
